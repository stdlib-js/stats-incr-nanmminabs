...
/**
* Returns an accumulator function which incrementally computes a moving minimum absolute value, ignoring `NaN` values.
*
...
* // returns 3.0
*/
function incrnanmminabs( W ) {
	var mminabs = incrmminabs( W );
	return accumulator;
